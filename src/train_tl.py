...
def train(model, graph, epochs, device, learning_rate, loss_function):
    ...
    for epoch in range(epochs):
        ...
        loss = F.nll_loss(prediction[graph.train_mask], graph.y[graph.train_mask])

        train_accuracy += accuracy(prediction, graph.y)
